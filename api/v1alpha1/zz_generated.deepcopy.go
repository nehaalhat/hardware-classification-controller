...
func (in *HardwareClassificationControllerSpec) DeepCopyInto(out *HardwareClassificationControllerSpec) {
	*out = *in
	...
	in.ValidationError.DeepCopyInto(&out.ValidationError)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NICS) DeepCopyInto(out *NICS) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NICS.
func (in *NICS) DeepCopy() *NICS {
	if in == nil {
		return nil
	}
	out := new(NICS)
